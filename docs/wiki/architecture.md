...
2. 플레이어·적·일반탄 이동과 스킬탄 최근접 관성 조향 및 화면 이탈 처리
3. 적 스폰 타이머 처리
...
- 스킬탄은 MANA 규칙을 만족하는 Space 입력 중에만 생성되고, 초기 확산 뒤 최근접 생존 적을 향해 점진적으로 조향한다.
