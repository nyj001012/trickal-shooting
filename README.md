...
React와 Canvas 2D로 만든 트릭컬 슈팅게임 그레이박스입니다. 이미지·사운드 없이 도형만으로 이동, 발사, 적 스폰, 충돌, 점수·레벨 진행, 게임오버와 재시작까지의 플레이 루프를 검증합니다.
...
현재 범위에는 백엔드, 영속 저장, 배포 인프라, 실제 에셋과 MANA 스킬 발동이 포함되지 않습니다.
